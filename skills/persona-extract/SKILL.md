...
Output a complete `promptonality` pack YAML using the repo contract. Requirements:
...
- If useful, you may append a short optional note showing how this pack would pair with a specific base workflow, but the YAML is the primary output.
