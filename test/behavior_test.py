...
def main() -> None:
    ...
    persona_start = (root_dir / "src" / "skills" / "persona-start" / "SKILL.md").read_text(encoding="utf-8")
    persona_apply = (root_dir / "src" / "skills" / "persona-apply" / "SKILL.md").read_text(encoding="utf-8")
    persona_list = (root_dir / "src" / "skills" / "persona-list" / "SKILL.md").read_text(encoding="utf-8")
    ...
    assert_contains(persona_start, "If the user names a workflow and a discovered persona pack, compose them explicitly")
    ...
    print("6. persona-apply handles one-off composition without requiring a named skill")
    ...
    print("7. persona-list exposes discovered assets and the ad-hoc composition rule")
    ...
    assert_contains(persona_list, "Listing a persona asset does not mean every possible workflow-plus-pack combination already exists as a named installed skill")
